...
# GNU Radio version: v3.11.0.0git-522-g1aa42876
...
class pluto_pulsed(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "pluto_pulsed")
...
def main(top_block_cls=pluto_pulsed, options=None):
