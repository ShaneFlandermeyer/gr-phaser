...
class phaser_zmq_host(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "phaser_zmq_host")
        ...
        self.phaser_sum_beams_0 = phaser.sum_beams('phaser:beam[0-9]+')
        ...
        self.msg_connect((self.zeromq_pull_msg_source_0, 'out'), (self.phaser_sum_beams_0, 'in'))
